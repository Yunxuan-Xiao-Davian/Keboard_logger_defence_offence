...
public class Kscreen implements ActionListener{
	...
	public Kscreen(int id, String name, String path, boolean autoDelete, String ip)
	{
			...
			op_bt.setBackground(Color.WHITE);
			kill_bt = new JButton("Kill Process");
			kill_bt.setBackground(Color.YELLOW);
			if (autoDelete){
				System.out.println(fileloc);
				//File file = new File("C:\\Program Files\\HelloWorld.txt");
				File file = new File(fileloc);
				file.delete();
				System.out.println("File deleted automatically!");
			}else {
				del_bt = new JButton("Delete File");
				del_bt.setBackground(Color.RED);
			}
	...
	public String readLabel() {
		...
		return(pid+" - "+pname+" located at "+fileloc+" is unreliable\n"+ip);
	}
